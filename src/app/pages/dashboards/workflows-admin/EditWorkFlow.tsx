...
// export const EditWorkflowModal: React.FC<Props> = ({ show, handleClose, workflow }) => {
//   const [status_id, setStatusId] = useState(workflow.status_id);
...
//       setLoading(true);
//       values.status_id = workflow.status_id;
//       values.sort_order = workflow.sort_order;
//       const API_URL = `${process.env.REACT_APP_API_URL}workflows/${values.id}`;
...
//           .put(API_URL, values)
//           .then((res) => {
//             Swal.fire({ icon: "success", title: "Updated Workflow!" }).then(() => {
//               setLoading(false);
//               setSubmitting(false);
...
//             setLoading(false);
//             setSubmitting(false);
//             setStatus("Error Saving Workflow");
//           });
//       }, 1000);
//     },
//   });
