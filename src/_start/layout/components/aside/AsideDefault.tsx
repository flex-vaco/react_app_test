              ...
              >
                ...
                >
                  <ul className="nav flex-column">
                    ...
                    <li className="nav-item mb-1" title="Users">
                      <Link
                        to="/calypso/user-admin"
                    ...
                    <li className="nav-item mb-1" title="Projects">
                      <Link
                        to="/calypso/project-admin"
                        className="nav-link h-40px w-40px  h-lg-50px w-lg-50px btn btn-custom btn-icon btn-color-white"
                        role="tab"
                      >
                        <KTSVG
                    ...
                    <li className="nav-item mb-1" title="Workflows">
                      <Link
                        to="/calypso/workflow-admin"
                        className="nav-link h-40px w-40px  h-lg-50px w-lg-50px btn btn-custom btn-icon btn-color-white"
                        role="tab"
                      >
                        <KTSVG
                    ...
                    <li className="nav-item mb-1" title="Tasks">
                      <Link
                        to="/calypso/task-admin"
                        className="nav-link h-40px w-40px  h-lg-50px w-lg-50px btn btn-custom btn-icon btn-color-white"
                        role="tab"
                      >
                        <KTSVG
                    ...
                    <li className="nav-item mb-1" title="Analytics">
                    <Link
                        to="/calypso/analytics"
                        className="nav-link h-40px w-40px  h-lg-50px w-lg-50px btn btn-custom btn-icon btn-color-white"
                        role="tab"
                      >
                        <KTSVG
                          className="svg-icon-2 svg-icon-lg-1"
                          path="/media/icons/duotone/Design/Magic.svg"
                        />
                        </Link>
                    </li>
                    <li className="nav-item mb-1" title="Analytics-Dashboard">
                    <Link
                        // to="/calypso/analytics-dashboard" -- OLD index.html link --
