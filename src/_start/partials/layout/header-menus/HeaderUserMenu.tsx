  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="">
          <span className="text-white fw-bolder fs-4">Hello, {user?.uid}</span>
      ...
      <div className="row row-cols-2 g-0">
        {/* <Link
          to="/profile"
          className="border-bottom border-end text-center py-10 btn btn-active-color-primary rounded-0 disabled"
        ...
        <Link
          to="/profile/settings"
          className="col border-bottom text-center py-10 btn btn-active-color-primary rounded-0 disabled"
          data-kt-menu-dismiss="true"
        >
          <KTSVG
            className="svg-icon-3x me-n1"
      ...
      */}
        <Link
          to="/profile/account"
          className="col text-center border-end py-10 btn btn-active-color-primary rounded-0 disabled"
          data-kt-menu-dismiss="true"
        >
          {/* <KTSVG
            className="svg-icon-3x me-n1"
          ...
          /> */}
          <span className="fw-bolder fs-6 d-block pt-3"></span>
        </Link>

        <Link
          to="/logout"
          className="col text-center py-10 btn btn-active-color-warning rounded-0"
          data-kt-menu-dismiss="true"
        >
          <KTSVG
            className="svg-icon-3x me-n1"
